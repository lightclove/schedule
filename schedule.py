...
# Чтобы получить все задания из планировщика, используйте schedule.get_jobs().
def hello():
    print('Hello world')
...
# Вы можете получить группу заданий из планировщика, выбрав их по уникальному идентификатору.
def greet(name):
    print('Hello {}'.format(name))
...
########################################################################################################################
# Run a job until a certain time¶ Запуск задания до определенного времени
def job():
    print('Boo')
...
# Используйте schedule.idle_seconds(), чтобы получить количество секунд до запланированного запуска следующего задания.
# Возвращаемое значение отрицательное, если запуск следующих запланированных заданий был запланирован ранее.
# Возвращает None, если никакие задания не запланированы.
def job():
    print('Hello')
